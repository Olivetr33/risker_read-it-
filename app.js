...
const COLUMN_MAPPINGS = {
    ...
    'Customer Name': ['Customer Name', 'customer name', 'CUSTOMER NAME', 'CustomerName', 'customername', 'CUSTOMERNAME', 'Customer Number', 'customer number', 'CUSTOMER NUMBER', 'CustomerNumber', 'customernumber', 'CUSTOMERNUMBER', 'Kunde', 'kunde', 'KUNDE', 'Kundenname', 'kundenname', 'KUNDENNAME', 'Kundennummer', 'kundennummer', 'KUNDENNUMMER', 'Kunden Nr', 'Kunden Nr.', 'Kunden-Nr', 'KundenNr', 'KundenID', 'Kunden ID', 'Customer ID', 'customer id', 'CustomerID', 'customerid', 'Name', 'name', 'NAME', 'Client', 'client', 'CLIENT'],
